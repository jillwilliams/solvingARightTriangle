...
// SOLVE FOR ALL 3 SIDES GIVEN 2 SIDES
    if (a != 0 && b != 0) {
        ...
        var answer4 = calculate.toFixed(2);
            return answer4;
    } else
    if (a != 0 && c != 0) {
    ...
    if (a != 0 && b != 0) {
        ...
        var answer5 = calculate.toFixed(2);
            return answer5;
    } else
    if (a != 0 && c != 0) {
...
// *****SOLVE GIVEN ONE SIDE AND ANGLE BETA*****
    if (a != 0 && beta != 0) {
        ...
        var answer3 = calculate.toFixed(2);
            return answer3;
    } else
    if (a != 0 && beta != 0) {
        var calculate = a*Math.tan(beta);
        var answer2 = calculate.toFixed(2);
            return answer2;
    } else
    if (b != 0 && beta != 0) {
    ...
    if (b != 0 && beta != 0) {
        ...
        var answer1 = calculate.toFixed(2);
            return answer1;
    } else
    if (c != 0 && beta != 0) {
